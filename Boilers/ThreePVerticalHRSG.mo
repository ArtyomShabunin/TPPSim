...
model ThreePVerticalHRSG
  ...
  Modelica.Fluid.Interfaces.FluidPort_b RH_Out(redeclare package Medium = Medium_F) annotation(
    Placement(visible = true, transformation(origin = {100, -90}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {140, -110}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Fluid.Interfaces.FluidPort_a RH_In(redeclare package Medium = Medium_F) annotation(
    Placement(visible = true, transformation(origin = {-100, -106}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-200, -90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  connect(RH.flowOut, RH_Out) annotation(
    Line(points = {{-8, -90}, {100, -90}}, color = {0, 127, 255}));
  connect(checkValve.port_b, RH.flowOut) annotation(
    Line(points = {{-40, -48}, {-40, -48}, {-40, -84}, {-8, -84}, {-8, -90}, {-8, -90}}, color = {0, 127, 255}));
  connect(RH.gasOut, HP_SH.gasIn) annotation(
    Line(points = {{-18, -99}, {-18, -77}}, color = {0, 127, 255}));
  connect(RH.gasIn, gasIn) annotation(
    Line(points = {{-18, -89}, {-18, -120}}, color = {0, 127, 255}));
  connect(RH.flowIn, RH_In) annotation(
    Line(points = {{-8, -98}, {-8, -107}, {-100, -107}, {-100, -106}}, color = {0, 127, 255}));
