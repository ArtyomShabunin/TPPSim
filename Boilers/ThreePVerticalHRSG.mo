...
model ThreePVerticalHRSG "Вертикальный трехконтурынй барабанный КУ"
  extends TPPSim.Boilers.ThreePVerticalHRSG_pattern(RH_3.k_weight_metal = 1.2);
  //Параметры
