...
model ThreePVerticalOTHRSG
  ...
  Modelica.Blocks.Logical.Greater HPTC_gr annotation(
    Placement(visible = true, transformation(origin = {-59, -57}, extent = {{-6, 6}, {6, -6}}, rotation = 90)));
  ...
  //Контур СД
  //Испаритель СД
  TPPSim.HRSG_HeatExch.GFHE IP_EVO(redeclare TPPSim.HRSG_HeatExch.FlowSide2phHE flowHE(redeclare TPPSim.thermal.alfa20000 alpha), redeclare package Medium_G = Medium_G, redeclare package Medium_F = Medium_F, Din = 34e-3, HRSG_type_set = TPPSim.Choices.HRSG_type.verticalTop, Lpipe = 20.4, delta = 2e-3, delta_fin = 0.8e-3, flowEnergyDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, flowMassDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, flowMomentumDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, gasEnergyDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, gasMassDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, hfin = 15e-3, k_gamma_gas = 1, metalDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, numberOfTubeSections = 1, s1 = 91.64e-3, s2 = 79e-3, sfin = 4.287e-3, z1 = 118, z2 = 6, zahod = 2) annotation(
  ...
  //Испаритель НД
  TPPSim.HRSG_HeatExch.GFHE LP_EVO(redeclare TPPSim.HRSG_HeatExch.FlowSide2phHE flowHE(redeclare TPPSim.thermal.alfa20000 alpha), redeclare package Medium_G = Medium_G, redeclare package Medium_F = Medium_F, Din = 0.032, HRSG_type_set = TPPSim.Choices.HRSG_type.verticalTop, Lpipe = 20.4, delta = 0.003, delta_fin = 0.0008, flowEnergyDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, flowMassDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, flowMomentumDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, gasEnergyDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, gasMassDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, hfin = 0.017, k_gamma_gas = 1, metalDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, numberOfTubeSections = 1, s1 = 82.04e-3, s2 = 110e-3, sfin = 2.868e-3, z1 = 174, z2 = 6, zahod = 3) annotation(
  ...
  Modelica.Fluid.Sensors.Temperature Tg_out_LPSH2(redeclare package Medium = Medium_G) annotation(
    Placement(visible = true, transformation(origin = {-39, 77}, extent = {{5, -5}, {-5, 5}}, rotation = 0)));
  ...
  Modelica.Fluid.Interfaces.FluidPort_a IP_FW_In(redeclare package Medium = Medium_F) annotation(
    Placement(visible = true, transformation(origin = {-100, 96}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-200, -32}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  TPPSim.Valves.simpleValve IP_FWCV(redeclare package Medium = Medium_F, dp = 100000, setD_flow = 5, use_D_flow_in = true) annotation(
    Placement(visible = true, transformation(origin = {-65, 95}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  ...
  Modelica.Blocks.Sources.Ramp LP_set_circ_flow(duration = 20, height = 50, offset = 0.01, startTime = 1)  annotation(
    Placement(visible = true, transformation(origin = {-1, 163}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
  Modelica.Blocks.Sources.Ramp IP_set_circ_flow(duration = 20, height = 50, offset = 0.01, startTime = 2)  annotation(
    Placement(visible = true, transformation(origin = {3, 101}, extent = {{-5, -5}, {5, 5}}, rotation = 0)));
equation
  connect(IP_set_circ_flow.y, IP_circPump.D_flow_in) annotation(
    Line(points = {{8, 102}, {10, 102}, {10, 88}, {6, 88}, {6, 72}, {8, 72}}, color = {0, 0, 127}));
  connect(LP_set_circ_flow.y, LP_circPump.D_flow_in) annotation(
    Line(points = {{4, 164}, {8, 164}, {8, 158}, {6, 158}, {6, 152}, {6, 152}}, color = {0, 0, 127}));
  connect(IP_LC.y, IP_FWCV.D_flow_in) annotation(
    Line(points = {{82, 82}, {86, 82}, {86, 108}, {-44, 108}, {-44, 102}, {-66, 102}, {-66, 96}, {-64, 96}}, color = {0, 0, 127}));
  connect(IP_ECO_HP_ECO_1.gasOut, LP_SH_1.gasIn) annotation(
    Line(points = {{-18, 108}, {-18, 108}, {-18, 118}, {-18, 118}}, color = {0, 127, 255}));
  connect(LP_SH_2.gasOut, IP_ECO_HP_ECO_1.gasIn) annotation(
    Line(points = {{-18, 88}, {-18, 88}, {-18, 96}, {-18, 96}}, color = {0, 127, 255}));
  connect(IP_ECO_HP_ECO_1.flowOut_1, IP_drum.fedWater) annotation(
    Line(points = {{-28, 98}, {-32, 98}, {-32, 92}, {16, 92}, {16, 92}, {16, 92}}, color = {0, 127, 255}));
  connect(IP_FWCV.flowOut, IP_ECO_HP_ECO_1.flowIn_1) annotation(
    Line(points = {{-60, 96}, {-40, 96}, {-40, 106}, {-28, 106}, {-28, 106}}, color = {0, 127, 255}));
  connect(IP_FW_In, IP_FWCV.flowIn) annotation(
    Line(points = {{-100, 96}, {-70, 96}, {-70, 96}, {-70, 96}}));
  connect(IP_ECO_HP_ECO_1.flowOut_2, HP_ECO_2.flowIn) annotation(
    Line(points = {{-8, 98}, {-4, 98}, {-4, 26}, {-8, 26}, {-8, 26}}, color = {0, 127, 255}));
  connect(FWCV.port_b, IP_ECO_HP_ECO_1.flowIn_2) annotation(
    Line(points = {{-44, 116}, {-38, 116}, {-38, 112}, {-8, 112}, {-8, 106}, {-8, 106}}, color = {0, 127, 255}));
  connect(LP_SH_1.flowOut, LP_SH_2.flowIn) annotation(
    Line(points = {{-8, 118}, {-6, 118}, {-6, 86}, {-8, 86}, {-8, 86}}, color = {0, 127, 255}));
  connect(IP_pipe_2.waterOut, IP_relativePressure.port_a) annotation(
    Line(points = {{40, -18}, {48, -18}, {48, -40}, {76, -40}, {76, -44}, {76, -44}}, color = {0, 127, 255}));
  connect(IP_EVO.gasOut, Tg_out_LPSH2.port) annotation(
    Line(points = {{-18, 68}, {-18, 72}, {-39, 72}}, color = {0, 127, 255}));
  connect(Tg_out_RH1.T, HPTC_gr.u1) annotation(
    Line(points = {{-46, -78}, {-60, -78}, {-60, -64}, {-58, -64}}, color = {0, 0, 127}));
  connect(HPTC_const.y, HPTC_gr.u2) annotation(
    Line(points = {{-88, -86}, {-64, -86}, {-64, -64}}, color = {0, 0, 127}));
  connect(HPTC_gr.y, HP_TC.on) annotation(
    Line(points = {{-59, -50}, {-59, -48}, {-4, -48}, {-4, -45}, {37, -45}}, color = {255, 0, 255}));
