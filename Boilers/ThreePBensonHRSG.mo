...
model ThreePBensonHRSG "Котел-утилизатор с испарителем высокого давления типа 'Бенсона' для ГТУ SGT5-4000F"
  ...
  //Барабаны/Сепараторы
  TPPSim.Drums.Separator2 HP_separator(redeclare package Medium = Medium_F) annotation(
  ...
  TPPSim.Pipes.ComplexPipe HP_pipe_2(redeclare TPPSim.Pipes.ElementaryPipe Pipe, Din = 0.3, Lpiezo = 0, Lpipe = 18.29, delta = 0.01, energyDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, massDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, momentumDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, n_parallel = 2, numberOfVolumes = 2) annotation(
    Placement(visible = true, transformation(origin = {-60, -8}, extent = {{4, -4}, {-4, 4}}, rotation = -90)));
  ...
  //Регуляторы уровня/температуры
  TPPSim.Controls.TC HT_TC(T_sprh = 60, Ti = 10, k = 2e-005, yMax = 75, y_start = 20) annotation(
    Placement(visible = true, transformation(origin = {3, 1}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
...
equation
  ...
  connect(e_HP_EVO_out.h_out, HT_TC.h) annotation(
    Line(points = {{-16, -4}, {-12, -4}, {-12, 2}, {-6, 2}, {-6, 2}}, color = {0, 0, 127}));
  connect(p_HP_EVO_out.p, HP_p_drum) annotation(
    Line(points = {{-16, 8}, {-12, 8}, {-12, 18}, {-58, 18}, {-58, 28}, {-90, 28}, {-90, 100}, {-90, 100}}, color = {0, 0, 127}));
  connect(HT_TC.y, HP_FWCV.D_flow_in) annotation(
    Line(points = {{10, 2}, {18, 2}, {18, 14}, {100, 14}, {100, -88}, {126, -88}, {126, -94}, {126, -94}}, color = {0, 0, 127}));
  connect(HP_separator.fedWater, e_HP_EVO_out.port) annotation(
    Line(points = {{-58, 12}, {-50, 12}, {-50, 2}, {-36, 2}, {-36, -10}, {-20, -10}, {-20, -10}}, color = {0, 127, 255}));
  connect(HP_separator.fedWater, p_HP_EVO_out.port) annotation(
    Line(points = {{-58, 12}, {-50, 12}, {-50, 2}, {-20, 2}, {-20, 2}}, color = {0, 127, 255}));
  connect(HP_separator.fedWater, t_HP_EVO_out.port) annotation(
    Line(points = {{-58, 12}, {-50, 12}, {-50, 6}, {-42, 6}, {-42, 6}}, color = {0, 127, 255}));
  ...
  connect(HP_pipe_1.waterOut, HP_SH_2.flowIn) annotation(
    Line(points = {{-74, -10}, {-74, -10}, {-74, -16}, {-106, -16}, {-106, -20}, {-106, -20}}, color = {0, 127, 255}));
  connect(HP_EVO_1.gasOut, IP_SH_2.gasIn) annotation(
    Line(points = {{-40, -30}, {-28, -30}, {-28, -30}, {-28, -30}}, color = {0, 127, 255}));
  connect(HP_EVO_2.gasOut, HP_EVO_1.gasIn) annotation(
    Line(points = {{-62, -30}, {-52, -30}, {-52, -30}, {-50, -30}}, color = {0, 127, 255}));
  connect(RH_1.gasOut, HP_EVO_2.gasIn) annotation(
    Line(points = {{-84, -30}, {-72, -30}, {-72, -30}, {-72, -30}}, color = {0, 127, 255}));
  connect(HP_separator.steam, HP_pipe_1.waterIn) annotation(
    Line(points = {{-66, 16}, {-66, 16}, {-66, 18}, {-74, 18}, {-74, -2}, {-74, -2}}, color = {0, 127, 255}));
  connect(HP_pipe_2.waterOut, HP_separator.fedWater) annotation(
    Line(points = {{-60, -4}, {-60, -4}, {-60, 4}, {-54, 4}, {-54, 12}, {-58, 12}, {-58, 12}}, color = {0, 127, 255}));
  connect(HP_EVO_2.flowOut, HP_pipe_2.waterIn) annotation(
    Line(points = {{-68, -20}, {-68, -20}, {-68, -16}, {-60, -16}, {-60, -12}, {-60, -12}}, color = {0, 127, 255}));
  connect(HP_pipe_3.waterOut, HP_EVO_2.flowIn) annotation(
    Line(points = {{-46, -6}, {-46, -6}, {-46, -2}, {-56, -2}, {-56, -44}, {-68, -44}, {-68, -40}, {-68, -40}}, color = {0, 127, 255}));
  connect(HP_EVO_1.flowOut, HP_pipe_3.waterIn) annotation(
    Line(points = {{-46, -20}, {-46, -20}, {-46, -14}, {-46, -14}}, color = {0, 127, 255}));
  connect(HP_ECO_2.flowOut, HP_EVO_1.flowIn) annotation(
    Line(points = {{-8, -20}, {-8, -20}, {-8, -16}, {-34, -16}, {-34, -44}, {-46, -44}, {-46, -40}, {-46, -40}}, color = {0, 127, 255}));
  ...
  connect(LP_blowdown.port_b, flash_tank.ports[1]) annotation(
  ...
  <p>
  Модель КУ горизонтальной компоновки с испарителем высокого давления типа Бенсона.
  </p>
