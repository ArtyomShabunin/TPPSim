...
model OnePVerticalOTHRSG
  ...
  TPPSim.Controls.TC tc1(T_sprh = 60,yMax = 50, y_start = 20)  annotation(
...
equation
  connect(booleanConstant1.y, tc1.on) annotation(
    Line(points = {{58, 74}, {66, 74}, {66, 44}, {38, 44}, {38, 44}}, color = {255, 0, 255}));
  connect(tc1.y, FWCV.D_flow_in) annotation(
    Line(points = {{21, 40}, {8, 40}, {8, 64}, {-37, 64}, {-37, 50}}, color = {0, 0, 127}));
  connect(pressure1.p, tc1.p) annotation(
    Line(points = {{72, 8}, {76, 8}, {76, 37}, {40, 37}}, color = {0, 0, 127}));
  connect(specificEnthalpy.h_out, tc1.h) annotation(
    Line(points = {{104, 14}, {102, 14}, {102, 42}, {40, 42}}, color = {0, 0, 127}));
