...
model OnePVerticalOTHRSG
  ...
  TPPSim.Controls.LC_sink HP_LC(DFmax = 30, DFmin = 0, L = 7) annotation(
    Placement(visible = true, transformation(origin = {45, 3}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  ...
  TPPSim.Pumps.simplePump HP_sink_valve(redeclare package Medium = Medium_F, setD_flow = 0, use_D_flow_in = true) annotation(
    Placement(visible = true, transformation(origin = {60, -54}, extent = {{6, -6}, {-6, 6}}, rotation = 0)));
  ...
  Modelica.Fluid.Interfaces.FluidPort_b HP_Out(redeclare package Medium = Medium_F) annotation(
    Placement(visible = true, transformation(origin = {100, -86}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {200, -90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  ...
  connect(HP_sink_valve.port_b, flash_tank.ports[1]) annotation(
    Line(points = {{66, -54}, {80, -54}}, color = {0, 127, 255}));
  connect(HP_LC.y, HP_sink_valve.D_flow_in) annotation(
    Line(points = {{52.7, 3}, {59.7, 3}, {59.7, -22.5}, {59.7, -22.5}, {59.7, -35.25}, {59.7, -35.25}, {59.7, -48}}, color = {0, 0, 127}));
  connect(HP_separator.downWater, HP_sink_valve.port_a) annotation(
    Line(points = {{12, -14}, {12, -34}, {12, -34}, {12, -54}, {33, -54}, {33, -54}, {54, -54}}, color = {0, 127, 255}));
  connect(HP_TC.y, FWCV.opening) annotation(
    Line(points = {{53, 27}, {57.7, 27}, {57.7, 56}, {-51.3, 56}, {-51.3, 67}}, color = {0, 0, 127}));
  connect(HP_separator.level, HP_LC.u) annotation(
    Line(points = {{17, 1.8}, {22, 1.8}, {22, 1.8}, {27, 1.8}, {27, 2.8}, {32, 2.8}, {32, 2.8}, {37, 2.8}}, color = {0, 0, 127}));
  ...
  connect(HP_SH_2.flowOut, HP_Out) annotation(
    Line(points = {{-8, -52}, {-4, -52}, {-4, -52}, {0, -52}, {0, -86}, {100, -86}, {100, -86}, {100, -86}, {100, -86}}, color = {0, 127, 255}));
  ...
  connect(HP_ECO_3.flowOut, HP_EVO_1.flowIn) annotation(
    Line(points = {{-8, 42}, {-6, 42}, {-6, 22}, {-8, 22}}, color = {0, 127, 255}));
