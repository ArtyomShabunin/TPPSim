...
model EMA_028_HRSG "Котел-утилизатор ЭМА-028-КУ энергоблока ПГУ-410 Ново-Салаватской ТЭЦ"
  ...
  //    Placement(visible = true, transformation(origin = {44, -30}, extent = {{-10, 10}, {10, -10}}, rotation = 180)));
  //Барабаны
  TPPSim.Drums.Drum HP_drum(Din = 1.6, Dynamics = if SH_cold_start == true then Modelica.Fluid.Types.Dynamics.SteadyStateInitial else Modelica.Fluid.Types.Dynamics.FixedInitial, Hw_start = 0.34, L = 14.05, delta = 0.0105, ps_start = HP_p_flow_start, t_m_steam_start = HP_t_m_steam_start, t_m_water_start = HP_t_m_water_start) annotation(
    Placement(visible = true, transformation(origin = {-50, -10}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  TPPSim.Drums.Drum IP_drum(Din = 1.4, Dynamics = if SH_cold_start == true then Modelica.Fluid.Types.Dynamics.SteadyStateInitial else Modelica.Fluid.Types.Dynamics.FixedInitial, Hw_start = 0.4, L = 13.1, delta = 30e-3, ps_start = IP_p_flow_start, t_m_steam_start = IP_t_m_steam_start, t_m_water_start = IP_t_m_water_start) annotation(
    Placement(visible = true, transformation(origin = {44, -10}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  TPPSim.Drums.Drum LP_drum(Din = 1.4, Dynamics = if SH_cold_start == true then Modelica.Fluid.Types.Dynamics.SteadyStateInitial else Modelica.Fluid.Types.Dynamics.FixedInitial, Hw_start = 0.48, L = 13.1, delta = 16e-3, m_flow_small = 2 * system.m_flow_small, ps_start = LP_p_flow_start, t_m_steam_start = LP_t_m_steam_start, t_m_water_start = LP_t_m_water_start) annotation(
