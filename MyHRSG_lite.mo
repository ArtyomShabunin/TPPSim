...
//Граничные условия
    ...
    package Tests
      model startUpTest_1
        ...
        MyHRSG_lite.Separator2 separator21(m_flow_small = 0.001) annotation(Placement(visible = true, transformation(origin = {14, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
// vapour/2-phase
      ...
      protected
        ...
        Real Pr_flow;
      algorithm
//if D_flow_n1 - m_flow_small < 0.001 * m_flow_small then
//alfa_flow := 0;
//else
...
//Уравнение теплового баланса металла
      deltaMMetal * C_m * der(t_m) = Q_flow - alfa_flow * deltaSFlow * max(t_m - t_flow, 0) "Уравнение баланса тепла металла (формула 3-2в диссертации Рубашкина)";
//Уравнения для heat
      heat.Q_flow = Q_flow;
      heat.T = t_m;
//Уравнения состояния
