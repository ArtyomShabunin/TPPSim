...
extends TPPSim.Nuclear.BaseClases.Icons.IconSteamGenerator;
  ...
  TPPSim.Nuclear.SodiumHE EVO(redeclare TPPSim.HRSG_HeatExch.FlowSide2phHE flowHE(redeclare TPPSim.thermal.alfaForEVO2 alpha(section = section)), redeclare package Medium_S = Medium_S, redeclare package Medium_F = Medium_F, T_m_start = 463.15, T_sodium_start = 463.15, flowEnergyDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, flowMassDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, flowMomentumDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, k_gamma_sodium = 0.6, k_volume = 10, k_volume_sodium = 10, k_weight_metal = 10, m_flow_start = 20 / n_sg, metalDynamics = Modelica.Fluid.Types.Dynamics.FixedInitial, numberOfVolumes = 20, p_flow_start = system.p_ambient, p_sodium_start = 250000, sodiumEnergyDynamics = Modelica.Fluid.Types.Dynamics.FixedInitial) annotation(
