...
model SteamGenerator_Test
  ...
  Modelica.Fluid.Sensors.Temperature loop_2_low_temp_1(redeclare package Medium = Medium_S) annotation(
  ...
  Modelica.Fluid.Sensors.Temperature loop_2_high_temp_2(redeclare package Medium = Medium_S) annotation(
  ...
  Modelica.Blocks.Continuous.LimPID s_temp_control_1( Ti = 10,controllerType = Modelica.Blocks.Types.SimpleController.PI,initType = Modelica.Blocks.Types.InitPID.InitialOutput, k = -0.5, limitsAtInit = true, yMax = 330, yMin = 100, y_start = 100)  annotation(
    Placement(visible = true, transformation(origin = {88, -100}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant set_stemp_1(k = 307 + 273.15)  annotation(
    Placement(visible = true, transformation(origin = {46, -100}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.CombiTimeTable input_data(columns = {2, 3, 4, 5}, fileName = "C:/Users/ASShabunin/TPPSim/Nuclear/Tests/CFR600_case1_5_70.txt", tableName = "tabl", tableOnFile = true)  annotation(
  ...
  Modelica.Blocks.Sources.Constant circ_pump1_nom(k = 3245 / 100)  annotation(
  ...
  Modelica.Blocks.Sources.Constant RS_pos(k = 1)  annotation(
    Placement(visible = true, transformation(origin = {140, 56}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant set_T_loop_1(k = 534 + 273.15)  annotation(
    Placement(visible = true, transformation(origin = {-102, -100}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Continuous.LimPID loop1_control(controllerType = Modelica.Blocks.Types.SimpleController.PI, initType = Modelica.Blocks.Types.InitPID.InitialOutput, k = -1, limitsAtInit = true, yMax = 3245, yMin = 1622.5, y_start = 1750)  annotation(
  ...
  Modelica.Blocks.Continuous.LimPID loop2_control( controllerType = Modelica.Blocks.Types.SimpleController.PI, initType = Modelica.Blocks.Types.InitPID.InitialOutput, k = -1, limitsAtInit = true, yMax = 2981, yMin = 1490.5, y_start = 1490.5)  annotation(
  ...
  Modelica.Fluid.Sensors.Temperature loop_2_high_temp_1(redeclare package Medium = Medium_S) annotation(
    Placement(visible = true, transformation(origin = {-10, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Fluid.Sensors.Temperature loop_2_low_temp_2(redeclare package Medium = Medium_S) annotation(
    Placement(visible = true, transformation(origin = {32, -70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Fluid.Sensors.Temperature loop_1_high_temp_1(redeclare package Medium = Medium_S) annotation(
    Placement(visible = true, transformation(origin = {-40, 42}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
equation
  connect(loop_1_high_temp_1.T, loop1_control.u_m) annotation(
    Line(points = {{-47, 42}, {-64, 42}, {-64, -88}}, color = {0, 0, 127}));
  connect(sodium_pipe_12.waterIn, loop_1_high_temp_1.port) annotation(
    Line(points = {{-24, 16}, {-26, 16}, {-26, 32}, {-40, 32}}, color = {0, 127, 255}));
  connect(loop_2_high_temp_1.T, loop2_control.u_m) annotation(
    Line(points = {{-2, 70}, {10, 70}, {10, -20}, {0, -20}, {0, -70}, {6, -70}, {6, -88}, {6, -88}}, color = {0, 0, 127}));
  connect(loop1_control.y, circPump_1.D_flow_in) annotation(
    Line(points = {{-52, -100}, {-48, -100}, {-48, -68}, {-60, -68}, {-60, -26}, {-48, -26}, {-48, -32}, {-48, -32}}, color = {0, 0, 127}));
  connect(loop2_control.y, circPump_2.D_flow_in) annotation(
    Line(points = {{18, -100}, {20, -100}, {20, -50}, {28, -50}, {28, -26}, {14, -26}, {14, -30}, {14, -30}}, color = {0, 0, 127}));
  connect(loop_2_low_temp_2.port, circPump_2.port_b) annotation(
    Line(points = {{32, -80}, {12, -80}, {12, -56}, {4, -56}, {4, -40}}, color = {0, 127, 255}));
  connect(sodium_pipe_22.waterIn, loop_2_high_temp_1.port) annotation(
    Line(points = {{6, 30}, {2, 30}, {2, 60}, {-10, 60}, {-10, 60}}, color = {0, 127, 255}));
  connect(sodium_pipe_22.waterOut, loop_2_high_temp_2.port) annotation(
    Line(points = {{18, 30}, {18, 34}, {22, 34}, {22, 38}}, color = {0, 127, 255}));
  connect(steamGenerator1.sodiumOut, loop_2_low_temp_1.port) annotation(
  ...
  connect(loop_2_low_temp_1.T, s_temp_control_1.u_m) annotation(
  ...
  experiment(StartTime = 0, StopTime = 25000, Tolerance = 0.01, Interval = 10));
