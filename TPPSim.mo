package TPPSim
  ...
  Параметры взяты из модели прямоточного котла для ГТЭ-110 в Thermoflex ''ВертрПрямКУсГТЭ110_OD''
    ...
    model threePDrumStartUp "Пуск трехконтурного барабанного КУ"
      ...
      TPPSim.HRSG_HeatExch.GFHE IP_SH(redeclare TPPSim.HRSG_HeatExch.FlowSideSH2 flowHE, redeclare package Medium_G = Medium_G, wgas = wgas, pgas = pgas, Tingas = Tingas_sh, Toutgas = Tingas_sh, k_gamma_gas = k_gamma_gas_sh, redeclare package Medium_F = Medium_F, wflow = wsteam, pflow_in = pflow_sh, pflow_out = pflow_sh, Tinflow = Tinflow_sh, Toutflow = Tinflow_sh, Din = Dout_sh - 2 * delta_sh, delta = delta_sh, s1 = s1_sh, s2 = s2_sh, zahod = zahod_sh, z1 = z1_sh, z2 = z2_sh, Lpipe = Lpipe, delta_fin = delta_fin_sh, hfin = hfin_sh, sfin = sfin_sh, seth_in = hflow_sh_in, seth_out = hflow_sh_out, setTm = setTm_ote2, numberOfVolumes = numberOfVolumes_sh, flow_DynamicMomentum = true, flow_DynamicMassBalance = true, flow_DynamicEnergyBalance = true, flow_DynamicTm = true, gas_DynamicMassBalance = true, gas_DynamicEnergyBalance = true, m_flow_small = 0.01) annotation(
      ...
      TPPSim.HRSG_HeatExch.GFHE_new IP_EVO(redeclare TPPSim.HRSG_HeatExch.FlowSideOTE3 flowHE, redeclare package Medium_G = Medium_G, HRSG_type_set = TPPSim.Choices.HRSG_type.verticalTop, wgas = wgas, pgas = pgas, Tingas = Tingas_ote2, Toutgas = Tingas_ote2, k_gamma_gas = k_gamma_gas_ote2, redeclare package Medium_F = Medium_F, wflow = wflow, pflow_in = pflow_ote2, pflow_out = pflow_ote2, Tinflow = Tinflow_ote2, Toutflow = Tinflow_ote2, Din = Din_ote2, delta = delta_ote2, s1 = s1_ote2, s2 = s2_ote2, zahod = zahod_ote2, z1 = z1_ote2, z2 = z2_ote2, Lpipe = Lpipe, delta_fin = delta_fin_ote2, hfin = hfin_ote2, sfin = sfin_ote2, seth_in = hflow_ote2_in, seth_out = hflow_ote2_out, setTm = setTm_ote2, numberOfTubeSections = numberOfTubeSections_ote2, flow_DynamicMomentum = false, flow_DynamicMassBalance = true, flow_DynamicEnergyBalance = true, flow_DynamicTm = true, gas_DynamicMassBalance = true, gas_DynamicEnergyBalance = true) annotation(
      ...
      TPPSim.HRSG_HeatExch.GFHE IP_ECO(redeclare TPPSim.HRSG_HeatExch.FlowSideECO flowHE, redeclare package Medium_G = Medium_G, HRSG_type_set = TPPSim.Choices.HRSG_type.verticalTop, wgas = wgas, pgas = pgas, Tingas = Tingas_eco, Toutgas = Tingas_eco, k_gamma_gas = k_gamma_gas_eco, redeclare package Medium_F = Medium_F, wflow = wflow, pflow_in = pflow_eco, pflow_out = pflow_eco, Tinflow = Tinflow_eco, Toutflow = Tinflow_eco, Din = Din_eco, delta = delta_eco, s1 = s1_eco, s2 = s2_eco, zahod = zahod_eco, z1 = z1_eco, z2 = z2_eco, Lpipe = Lpipe, delta_fin = delta_fin_eco, hfin = hfin_eco, sfin = sfin_eco, seth_in = hflow_eco_in, seth_out = hflow_eco_out, setTm = setTm_eco, numberOfVolumes = numberOfVolumes_eco, flow_DynamicMomentum = false, flow_DynamicMassBalance = false, flow_DynamicEnergyBalance = true, flow_DynamicTm = true, gas_DynamicMassBalance = true, gas_DynamicEnergyBalance = true) annotation(
      ...
      TPPSim.Controls.LC lc3(DFmax = 50, DFmin = 0, levelSP = 0.5) annotation(
    ...
    model GFHE_Test
      ...
      TPPSim.Gas_turbine.simple_startupGT GT(redeclare package Medium = Medium_G, Tnom = Tnom, Tstart = Tinflow_sh, gasSource.X = set_X) annotation(
        Placement(visible = true, transformation(origin = {70, 10}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
      /*TPPSim.HRSG_HeatExch.GFHE_glob_simple HP_EVO(redeclare TPPSim.HRSG_HeatExch.FlowSideOTE_glob flowHE, redeclare package Medium_G = Medium_G, HRSG_type_set = TPPSim.Choices.HRSG_type.verticalTop, wgas = wgas, Tingas = Tingas_ote2, Toutgas = Tingas_ote2, k_gamma_gas = k_gamma_gas_ote2, redeclare package Medium_F = Medium_F, wflow = wflow, pflow_in = pflow_ote2, pflow_out = pflow_ote2, Tinflow = Tinflow_ote2, Toutflow = Tinflow_ote2, Din = Din_ote2, delta = delta_ote2, s1 = s1_ote2, s2 = s2_ote2, zahod = zahod_ote2, z1 = z1_ote2, z2 = z2_ote2, Lpipe = Lpipe, delta_fin = delta_fin_ote2, hfin = hfin_ote2, sfin = sfin_ote2, seth_in = hflow_ote2_in, seth_out = hflow_ote2_out, setTm = setTm_ote2, numberOfTubeSections = numberOfTubeSections_ote2, flow_DynamicMomentum = false, flow_DynamicMassBalance = true, flow_DynamicEnergyBalance = true, flow_DynamicTm = true, gas_DynamicMassBalance = true, gas_DynamicEnergyBalance = true) annotation(
    ...
    model EvoTest
      ...
      TPPSim.Drums.Drum HP_drum(Din = Din_drum, L = L_drum, delta = 0.02, Hw_start = Hw_start_set) annotation(
        Placement(visible = true, transformation(origin = {120, 46}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      TPPSim.HRSG_HeatExch.GFHE_glob HP_EVO(redeclare TPPSim.HRSG_HeatExch.FlowSideOTE_glob flowHE(replaceable TPPSim.thermal.alfaForSHandECO alpha), redeclare package Medium_G = Medium_G, HRSG_type_set = TPPSim.Choices.HRSG_type.verticalTop, wgas = wgas, Tingas = Tingas_ote2, Toutgas = Tingas_ote2, k_gamma_gas = k_gamma_gas_ote2, redeclare package Medium_F = Medium_F, wflow = wflow, pflow_in = pflow_ote2, pflow_out = pflow_ote2, Tinflow = Tinflow_ote2, Toutflow = Tinflow_ote2, Din = Din_ote2, delta = delta_ote2, s1 = s1_ote2, s2 = s2_ote2, zahod = zahod_ote2, z1 = z1_ote2, z2 = z2_ote2, Lpipe = Lpipe, delta_fin = delta_fin_ote2, hfin = hfin_ote2, sfin = sfin_ote2, seth_in = hflow_ote2_in, seth_out = hflow_ote2_out, setTm = setTm_ote2, numberOfTubeSections = numberOfTubeSections_ote2, flow_DynamicMomentum = false, flow_DynamicMassBalance = true, flow_DynamicEnergyBalance = true, flow_DynamicTm = true, gas_DynamicMassBalance = true, gas_DynamicEnergyBalance = true) annotation(
        Placement(visible = true, transformation(origin = {120, 12}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      TPPSim.Pumps.simplePump HP_circPump(redeclare package Medium = Medium_F, setD_flow = 50) annotation(
        Placement(visible = true, transformation(origin = {103, -5}, extent = {{5, -5}, {-5, 5}}, rotation = 0)));
    equation
      connect(CV2.port_b, flowSink.ports[1]) annotation(
        Line(points = {{160, 56}, {160, 56}, {160, -34}, {54, -34}, {54, -34}}, color = {0, 127, 255}));
      connect(gasSink.ports[1], HP_EVO.gasOut) annotation(
        Line(points = {{-80, 10}, {114, 10}, {114, 12}, {116, 12}}, color = {0, 127, 255}, thickness = 0.5));
      connect(flowSource.ports[1], HP_drum.fedWater) annotation(
        Line(points = {{-74, 50}, {78, 50}, {78, 56}, {114, 56}, {114, 56}}, color = {0, 127, 255}, thickness = 0.5));
      connect(HP_EVO.gasIn, GT.flowOut) annotation(
        Line(points = {{126, 12}, {176, 12}, {176, 8}, {176, 8}}, color = {0, 127, 255}));
      connect(HP_pipe.waterOut, CV2.port_a) annotation(
        Line(points = {{144, 32}, {144, 32}, {144, 26}, {152, 26}, {152, 56}, {152, 56}}, color = {0, 127, 255}));
      connect(HP_circPump.port_b, HP_EVO.flowIn) annotation(
        Line(points = {{108, -4}, {110, -4}, {110, 22}, {116, 22}, {116, 24}}, color = {0, 127, 255}));
      connect(HP_drum.downStr, HP_circPump.port_a) annotation(
        Line(points = {{114, 38}, {98, 38}, {98, -4}, {98, -4}}, color = {0, 127, 255}));
    ...
    model onePDrumStartUp
      ...
      TPPSim.Pumps.simplePump HP_circPump(redeclare package Medium = Medium_F, setD_flow = 50) annotation(
        Placement(visible = true, transformation(origin = {103, -5}, extent = {{5, -5}, {-5, 5}}, rotation = 0)));
      TPPSim.HRSG_HeatExch.GFHE HP_ECO(redeclare TPPSim.HRSG_HeatExch.FlowSideOTE3 flowHE, redeclare package Medium_G = Medium_G, HRSG_type_set = TPPSim.Choices.HRSG_type.verticalTop, wgas = wgas, Tingas = Tingas_eco, Toutgas = Tingas_eco, k_gamma_gas = k_gamma_gas_eco, redeclare package Medium_F = Medium_F, wflow = wflow, pflow_in = pflow_eco, pflow_out = pflow_eco, Tinflow = Tinflow_eco, Toutflow = Tinflow_eco, Din = Din_eco, delta = delta_eco, s1 = s1_eco, s2 = s2_eco, zahod = zahod_eco, z1 = z1_eco, z2 = z2_eco, Lpipe = Lpipe, delta_fin = delta_fin_eco, hfin = hfin_eco, sfin = sfin_eco, seth_in = hflow_eco_in, seth_out = hflow_eco_out, setTm = setTm_eco, numberOfVolumes = numberOfVolumes_eco, flow_DynamicMomentum = false, flow_DynamicMassBalance = false, flow_DynamicEnergyBalance = true, flow_DynamicTm = true, gas_DynamicMassBalance = true, gas_DynamicEnergyBalance = true) annotation(
        Placement(visible = true, transformation(origin = {76, 12}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
      connect(HP_ECO.flowOut, HP_drum.fedWater) annotation(
  ...
  package HRSG_HeatExch
    package BaseClases
      package Icons
        ...
        model IconGasSideHE
          annotation(
            Icon(graphics = {Rectangle(origin = {0, 21}, lineColor = {255, 0, 0}, fillColor = {255, 255, 127}, pattern = LinePattern.None, fillPattern = FillPattern.HorizontalCylinder, lineThickness = 0, extent = {{-100, 79}, {100, -121}}), Rectangle(origin = {0, 55}, lineColor = {81, 81, 81}, fillColor = {255, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.HorizontalCylinder, extent = {{-100, 45}, {100, -35}}), Rectangle(origin = {-80, 20}, fillColor = {74, 74, 74}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-2, 80}, {2, -40}}), Rectangle(origin = {-60, 20}, fillColor = {74, 74, 74}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-2, 80}, {2, -40}}), Rectangle(origin = {-40, 20}, fillColor = {74, 74, 74}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-2, 80}, {2, -40}}), Rectangle(origin = {0, 20}, fillColor = {74, 74, 74}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-2, 80}, {2, -40}}), Rectangle(origin = {-20, 20}, fillColor = {74, 74, 74}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-2, 80}, {2, -40}}), Rectangle(origin = {20, 20}, fillColor = {74, 74, 74}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-2, 80}, {2, -40}}), Rectangle(origin = {60, 20}, fillColor = {74, 74, 74}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-2, 80}, {2, -40}}), Rectangle(origin = {40, 20}, fillColor = {74, 74, 74}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-2, 80}, {2, -40}}), Rectangle(origin = {80, 20}, fillColor = {74, 74, 74}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-2, 80}, {2, -40}}), Rectangle(origin = {100, 20}, fillColor = {74, 74, 74}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-2, 80}, {0, -40}}), Rectangle(origin = {-98, 20}, fillColor = {74, 74, 74}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-2, 80}, {0, -40}}), Polygon(origin = {-30, -15.11}, lineColor = {255, 0, 0}, fillColor = {255, 85, 0}, lineThickness = 2, points = {{-6.0012, 51.1053}, {-8.0012, 41.1053}, {-8.0012, 23.1053}, {-6.0012, 11.1053}, {-2.00116, 1.10532}, {3.99884, -8.89468}, {7.99884, -20.8947}, {5.99884, -34.8947}, {-4.00116, -52.8947}, {-8.0012, -62.8947}, {-10.0012, -72.8947}, {-0.00116419, -72.8947}, {1.99884, -60.8947}, {7.99884, -46.8947}, {13.9988, -34.8947}, {15.9988, -18.8947}, {9.9988, -2.89468}, {3.99884, 7.10532}, {-0.00115991, 23.1053}, {-0.00115991, 39.1053}, {1.99884, 49.1053}, {3.99884, 59.1053}, {9.99884, 57.1053}, {1.99884, 75.1053}, {-12.0012, 57.1053}, {-4.0012, 59.1053}, {-6.0012, 51.1053}}), Polygon(origin = {2, 12.89}, lineColor = {255, 0, 0}, fillColor = {255, 85, 0}, lineThickness = 2, points = {{-6.0012, 51.1053}, {-8.0012, 41.1053}, {-8.0012, 23.1053}, {-6.0012, 11.1053}, {-2.00116, 1.10532}, {3.99884, -8.89468}, {7.99884, -20.8947}, {5.99884, -34.8947}, {-4.00116, -52.8947}, {-8.0012, -62.8947}, {-10.0012, -72.8947}, {-0.00116419, -72.8947}, {1.99884, -60.8947}, {7.99884, -46.8947}, {13.9988, -34.8947}, {15.9988, -18.8947}, {9.9988, -2.89468}, {3.99884, 7.10532}, {-0.00115991, 23.1053}, {-0.00115991, 39.1053}, {1.99884, 49.1053}, {3.99884, 59.1053}, {9.99884, 57.1053}, {1.99884, 75.1053}, {-12.0012, 57.1053}, {-4.0012, 59.1053}, {-6.0012, 51.1053}}), Polygon(origin = {34, -15.11}, lineColor = {255, 0, 0}, fillColor = {255, 85, 0}, lineThickness = 2, points = {{-6.0012, 51.1053}, {-8.0012, 41.1053}, {-8.0012, 23.1053}, {-6.0012, 11.1053}, {-2.00116, 1.10532}, {3.99884, -8.89468}, {7.99884, -20.8947}, {5.99884, -34.8947}, {-4.00116, -52.8947}, {-8.0012, -62.8947}, {-10.0012, -72.8947}, {-0.00116419, -72.8947}, {1.99884, -60.8947}, {7.99884, -46.8947}, {13.9988, -34.8947}, {15.9988, -18.8947}, {9.9988, -2.89468}, {3.99884, 7.10532}, {-0.00115991, 23.1053}, {-0.00115991, 39.1053}, {1.99884, 49.1053}, {3.99884, 59.1053}, {9.99884, 57.1053}, {1.99884, 75.1053}, {-12.0012, 57.1053}, {-4.0012, 59.1053}, {-6.0012, 51.1053}}), Text(origin = {2, -42}, extent = {{-62, 70}, {58, -50}}, textString = "Q")}),
            Diagram,
            __OpenModelica_commandLineOptions = "");
        end IconGasSideHE;

        model IconFlowSideHE
          annotation(
            Icon(graphics = {Rectangle(origin = {0, 21}, fillColor = {170, 170, 170}, pattern = LinePattern.None, fillPattern = FillPattern.Backward, lineThickness = 0, extent = {{-100, 79}, {100, -121}}), Rectangle(origin = {0, 55}, lineColor = {0, 85, 255}, fillColor = {0, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.CrossDiag, extent = {{-100, 45}, {100, -35}}), Polygon(origin = {-30, -15.11}, lineColor = {255, 0, 0}, fillColor = {255, 85, 0}, lineThickness = 2, points = {{-6.0012, 51.1053}, {-8.0012, 41.1053}, {-8.0012, 23.1053}, {-6.0012, 11.1053}, {-2.00116, 1.10532}, {3.99884, -8.89468}, {7.99884, -20.8947}, {5.99884, -34.8947}, {-4.00116, -52.8947}, {-8.0012, -62.8947}, {-10.0012, -72.8947}, {-0.00116419, -72.8947}, {1.99884, -60.8947}, {7.99884, -46.8947}, {13.9988, -34.8947}, {15.9988, -18.8947}, {9.9988, -2.89468}, {3.99884, 7.10532}, {-0.00115991, 23.1053}, {-0.00115991, 39.1053}, {1.99884, 49.1053}, {3.99884, 59.1053}, {9.99884, 57.1053}, {1.99884, 75.1053}, {-12.0012, 57.1053}, {-4.0012, 59.1053}, {-6.0012, 51.1053}}), Polygon(origin = {2, 12.89}, lineColor = {255, 0, 0}, fillColor = {255, 85, 0}, lineThickness = 2, points = {{-6.0012, 51.1053}, {-8.0012, 41.1053}, {-8.0012, 23.1053}, {-6.0012, 11.1053}, {-2.00116, 1.10532}, {3.99884, -8.89468}, {7.99884, -20.8947}, {5.99884, -34.8947}, {-4.00116, -52.8947}, {-8.0012, -62.8947}, {-10.0012, -72.8947}, {-0.00116419, -72.8947}, {1.99884, -60.8947}, {7.99884, -46.8947}, {13.9988, -34.8947}, {15.9988, -18.8947}, {9.9988, -2.89468}, {3.99884, 7.10532}, {-0.00115991, 23.1053}, {-0.00115991, 39.1053}, {1.99884, 49.1053}, {3.99884, 59.1053}, {9.99884, 57.1053}, {1.99884, 75.1053}, {-12.0012, 57.1053}, {-4.0012, 59.1053}, {-6.0012, 51.1053}}), Polygon(origin = {34, -15.11}, lineColor = {255, 0, 0}, fillColor = {255, 85, 0}, lineThickness = 2, points = {{-6.0012, 51.1053}, {-8.0012, 41.1053}, {-8.0012, 23.1053}, {-6.0012, 11.1053}, {-2.00116, 1.10532}, {3.99884, -8.89468}, {7.99884, -20.8947}, {5.99884, -34.8947}, {-4.00116, -52.8947}, {-8.0012, -62.8947}, {-10.0012, -72.8947}, {-0.00116419, -72.8947}, {1.99884, -60.8947}, {7.99884, -46.8947}, {13.9988, -34.8947}, {15.9988, -18.8947}, {9.9988, -2.89468}, {3.99884, 7.10532}, {-0.00115991, 23.1053}, {-0.00115991, 39.1053}, {1.99884, 49.1053}, {3.99884, 59.1053}, {9.99884, 57.1053}, {1.99884, 75.1053}, {-12.0012, 57.1053}, {-4.0012, 59.1053}, {-6.0012, 51.1053}}), Text(origin = {2, -42}, extent = {{-62, 70}, {58, -50}}, textString = "Q")}, coordinateSystem(initialScale = 0.1)),
            Diagram,
            __OpenModelica_commandLineOptions = "");
        end IconFlowSideHE;
        ...
        model IconSplitter
          annotation(
            Icon(graphics = {Rectangle(origin = {-60, -5}, fillColor = {132, 132, 132}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-40, 35}, {40, -25}}), Rectangle(origin = {60, 0}, fillColor = {132, 132, 132}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-40, 20}, {40, -20}}), Rectangle(origin = {-60, 0}, lineColor = {0, 85, 255}, fillColor = {0, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.CrossDiag, extent = {{-40, 20}, {40, -20}}), Rectangle(origin = {60, 0}, lineColor = {0, 85, 255}, fillColor = {0, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.CrossDiag, extent = {{-40, 12}, {40, -12}}), Rectangle(origin = {38, 50}, rotation = 45, fillColor = {132, 132, 132}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-40, 20}, {40, -24}}), Rectangle(origin = {38, 50}, rotation = 45, lineColor = {0, 85, 255}, fillColor = {0, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.CrossDiag, extent = {{-40, 12}, {40, -14}}), Rectangle(origin = {38, -50}, rotation = -45, fillColor = {132, 132, 132}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-40, 20}, {40, -20}}), Rectangle(origin = {38, -50}, rotation = 315, lineColor = {0, 85, 255}, fillColor = {0, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.CrossDiag, extent = {{-40, 12}, {40, -14}}), Ellipse(origin = {-1, 3}, fillColor = {132, 132, 132}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-59, 57}, {59, -63}}, endAngle = 360), Ellipse(origin = {1, -1}, lineColor = {0, 85, 255}, fillColor = {0, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.CrossDiag, extent = {{-41, 41}, {39, -39}}, endAngle = 360), Line(origin = {-50, -80}, points = {{-50, 0}, {50, 0}}, color = {0, 85, 255}, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 30)}, coordinateSystem(initialScale = 0.1)));
        end IconSplitter;

        model IconMixer
          annotation(
            Icon(graphics = {Rectangle(origin = {60, -7}, fillColor = {132, 132, 132}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-40, 35}, {40, -25}}), Rectangle(origin = {-60, 0}, fillColor = {132, 132, 132}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-40, 20}, {40, -20}}), Rectangle(origin = {60, -2}, lineColor = {0, 85, 255}, fillColor = {0, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.CrossDiag, extent = {{-40, 20}, {40, -20}}), Rectangle(origin = {-60, 0}, lineColor = {0, 85, 255}, fillColor = {0, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.CrossDiag, extent = {{-40, 12}, {40, -12}}), Rectangle(origin = {-38, -44}, rotation = 45, fillColor = {132, 132, 132}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-40, 20}, {40, -24}}), Rectangle(origin = {-38, -44}, rotation = 45, lineColor = {0, 85, 255}, fillColor = {0, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.CrossDiag, extent = {{-40, 12}, {40, -14}}), Rectangle(origin = {-38, 50}, rotation = -45, fillColor = {132, 132, 132}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-40, 20}, {40, -20}}), Rectangle(origin = {-38, 50}, rotation = 315, lineColor = {0, 85, 255}, fillColor = {0, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.CrossDiag, extent = {{-40, 12}, {40, -14}}), Ellipse(origin = {-1, 3}, fillColor = {132, 132, 132}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-59, 57}, {59, -63}}, endAngle = 360), Ellipse(origin = {1, -1}, lineColor = {0, 85, 255}, fillColor = {0, 255, 255}, pattern = LinePattern.None, fillPattern = FillPattern.CrossDiag, extent = {{-41, 41}, {39, -39}}, endAngle = 360), Line(origin = {50.0416, -80.8167}, points = {{-50, 0}, {50, 0}}, color = {0, 85, 255}, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 30)}, coordinateSystem(initialScale = 0.1)));
        end IconMixer;

        model IconGasSplitter
          annotation(
            Icon(graphics = {Rectangle(fillColor = {255, 255, 127}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-100, 80}, {100, -80}}), Line(origin = {49.97, -0.03}, points = {{-150, 0}, {50, 0}}, color = {255, 0, 0}, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 30), Line(origin = {32.42, 30.16}, points = {{-72.3957, -30.2023}, {-52.3957, -26.2023}, {-36.3957, -16.2023}, {-26.3957, 3.7977}, {-14.3957, 17.7977}, {1.60433, 25.7977}, {23.6043, 29.7977}, {67.6043, 29.7977}}, color = {255, 0, 0}, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 30), Line(origin = {32.52, -30.35}, points = {{-72.3957, 30.2023}, {-52.3957, 26.2023}, {-36.3957, 16.2023}, {-26.3957, -3.7977}, {-14.3957, -17.7977}, {1.60433, -25.7977}, {23.6043, -29.7977}, {67.6043, -29.7977}}, color = {255, 0, 0}, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 30)}, coordinateSystem(initialScale = 0.1)));
        end IconGasSplitter;

        model IconGasMixer
          annotation(
            Icon(graphics = {Rectangle(fillColor = {255, 255, 127}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-100, 80}, {100, -80}}), Line(origin = {49.97, -0.03}, points = {{-150, 0}, {50, 0}}, color = {255, 0, 0}, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 30), Line(origin = {-32.4479, 30.16}, points = {{72.3957, -30.2023}, {52.3957, -26.2023}, {36.3957, -16.2023}, {26.3957, 3.7977}, {14.3957, 17.7977}, {-1.60433, 25.7977}, {-23.6043, 29.7977}, {-67.6043, 29.7977}}, color = {255, 0, 0}, arrowSize = 30), Line(origin = {-32.4857, -30.2366}, points = {{72.3957, 30.2023}, {52.3957, 26.2023}, {36.3957, 16.2023}, {26.3957, -3.7977}, {14.3957, -17.7977}, {-1.60433, -25.7977}, {-23.6043, -29.7977}, {-67.6043, -29.7977}}, color = {255, 0, 0}, arrowSize = 30)}, coordinateSystem(initialScale = 0.1)));
        end IconGasMixer;
      end Icons;
...
//Уравнения для расчета процессов массообмена
    ...
    model GasSideHE_glob "Gas Flow Heat Exchanger Side. Модель газовой стороны газо-водяного/парового теплообменника котла-утилизатора с глобальными переменными."
      extends TPPSim.HRSG_HeatExch.BaseClases.Icons.IconGasSideHE;
      import TPPSim.functions.deltaPg_lite;
      replaceable package Medium = TPPSim.Media.ExhaustGas constrainedby Modelica.Media.Interfaces.PartialMedium;
      parameter Integer[2] section;
...
//Коэффициент теплоотдачи
    ...
    model GFHE_glob_simple
      ...
      //Исходные данные по разбиению
      parameter Integer numberOfVolumes "Число участков разбиения";
      //final inner parameter Integer numberOfTubeSections = 1 "Число участков разбиения трубы (для этой модели всегда 1 !!!)";
      final inner parameter Integer numberOfFlueSections = numberOfVolumes "Число участков разбиения газохода";
      //Конструктивные характеристики
    protected
      inner parameter Modelica.SIunits.Area f_flow = zahod * Modelica.Constants.pi * Din ^ 2 * z1 / 4 "Площадь для прохода теплоносителя";
      ...
      inner parameter Real H_fin = (omega * Lpipe * (1 - delta_fin / sfin) + (2 * Modelica.Constants.pi * (Dfin ^ 2 - (Din + 2 * delta) ^ 2) / 4 + Modelica.Constants.pi * Dfin * delta_fin) * (Lpipe / sfin)) * z1 * z2 / numberOfVolumes "Площадь оребренной поверхности";
      //Переменные
      inner Medium_F.SpecificEnthalpy h_gl[numberOfVolumes + 1, 1] "Энтальпия вода/пар (глобальная переменная)";
      inner Medium_F.MassFlowRate D_gl[numberOfVolumes + 1, 1] "Массовый расход вода/пар (глобальная переменная)";
      inner Medium_F.AbsolutePressure p_gl[numberOfVolumes + 1, 1] "Давление вода/пар (глобальная переменная)";
      ...
      TPPSim.HRSG_HeatExch.GasSideHE_glob gasHE[numberOfVolumes, 1](redeclare package Medium = Medium_G, DynamicEnergyBalance = gas_DynamicEnergyBalance, DynamicMassBalance = gas_DynamicMassBalance, section = section_set) annotation(
        Placement(visible = true, transformation(origin = {0, -36}, extent = {{-30, -30}, {30, 30}}, rotation = 0)));
      replaceable TPPSim.HRSG_HeatExch.FlowSideOTE_glob flowHE[numberOfVolumes, 1](redeclare package Medium = Medium_F, DynamicMomentum = flow_DynamicMomentum, DynamicMassBalance = flow_DynamicMassBalance, DynamicEnergyBalance = flow_DynamicEnergyBalance, DynamicTm = flow_DynamicTm, section = section_set, replaceable TPPSim.thermal.alfaForSHandECO alpha) annotation(
        Placement(visible = true, transformation(origin = {0, 32}, extent = {{-30, -30}, {30, 30}}, rotation = 0)));
    equation
      for i in 1:numberOfVolumes loop
        connect(flowHE[i].heat, gasHE[numberOfVolumes + 1 - i].heat);
      ...
      p_gl[1, 1] = flowIn.p;
      h_gl[numberOfVolumes + 1, 1] = flowOut.h_outflow;
      D_gl[numberOfVolumes + 1, 1] = -flowOut.m_flow;
      p_gl[numberOfVolumes + 1, 1] = flowOut.p;
  ...
  package Media
    model ExhaustGas "Выхлопные газы ГТУ"
    ...
    record section
      ...
      Integer tubeSection;
      annotation(
        Documentation(info = "<html><head></head><body>Record описывает координаты элемента модели</body></html>", revisions = "<html><head></head><body>
        <ul>
          <li><i>August 15, 2017</i>
       by Artyom Shabunin:<br></li>
    </ul></body></html>"));
...
The sensor is ideal, i.e., it does not influence the fluid.
    ...
    type TemperatureType = enumeration(subcooling "Недогрев до температуры насыщения", overheating "Перегрев свыше температуры насыщения") "Тип датчика температуры (недогрев/перегрев)";
  end Sensors;
  ...
  package Gas_turbine
    ...
    package BaseClases
      package Icons
        model IconGTstartUp
          annotation(
            Icon(graphics = {Polygon(origin = {90, 0}, fillColor = {255, 255, 255}, fillPattern = FillPattern.HorizontalCylinder, points = {{10, 55}, {-10, 40}, {-10, -40}, {10, -55}, {10, 55}}), Rectangle(origin = {50, 0}, fillColor = {255, 255, 255}, fillPattern = FillPattern.HorizontalCylinder, extent = {{30, 45}, {-35, -45}}), Rectangle(origin = {9, 0}, fillColor = {255, 255, 255}, fillPattern = FillPattern.HorizontalCylinder, extent = {{6, 50}, {-6, -50}}), Polygon(origin = {-7, 0}, fillColor = {255, 255, 255}, fillPattern = FillPattern.HorizontalCylinder, points = {{10, 50}, {-10, 25}, {-10, -25}, {10, -50}, {10, 50}}), Rectangle(origin = {-50, 0}, fillColor = {255, 255, 255}, fillPattern = FillPattern.HorizontalCylinder, extent = {{33, 25}, {-33, -25}}), Polygon(origin = {-91, 0}, fillColor = {255, 255, 255}, fillPattern = FillPattern.HorizontalCylinder, points = {{-9, 40}, {8, 25}, {8, -25}, {-9, -40}, {-9, 40}}), Rectangle(origin = {-81, 0}, fillColor = {255, 255, 255}, fillPattern = FillPattern.HorizontalCylinder, extent = {{2, 30}, {-2, -30}}), Rectangle(origin = {-49, 0}, fillColor = {255, 255, 255}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-9, 30}, {9, -30}}), Rectangle(origin = {-23, 0}, fillColor = {255, 255, 255}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-2, 30}, {2, -30}}), Line(origin = {55, 0}, points = {{-8, 45}, {-8, -45}}), Line(origin = {6, 0}, points = {{0, 50}, {0, -50}}), Line(origin = {10, 0}, points = {{0, 50}, {0, -50}}), Ellipse(origin = {-3, 35}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Sphere, lineThickness = 0.5, extent = {{-3, 2}, {3, -2}}, endAngle = 360), Ellipse(origin = {-3, 25}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Sphere, lineThickness = 0.5, extent = {{-3, 2}, {3, -2}}, endAngle = 360), Ellipse(origin = {-3, 15}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Sphere, lineThickness = 0.5, extent = {{-3, 2}, {3, -2}}, endAngle = 360), Ellipse(origin = {-3, 5}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Sphere, lineThickness = 0.5, extent = {{-3, 2}, {3, -2}}, endAngle = 360), Ellipse(origin = {-3, -5}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Sphere, lineThickness = 0.5, extent = {{-3, 2}, {3, -2}}, endAngle = 360), Ellipse(origin = {-3, -15}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Sphere, lineThickness = 0.5, extent = {{-3, 2}, {3, -2}}, endAngle = 360), Ellipse(origin = {-3, -25}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Sphere, lineThickness = 0.5, extent = {{-3, 2}, {3, -2}}, endAngle = 360), Ellipse(origin = {-3, -35}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Sphere, lineThickness = 0.5, extent = {{-3, 2}, {3, -2}}, endAngle = 360), Rectangle(origin = {-53, 74}, lineColor = {0, 0, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Cross, lineThickness = 0.5, extent = {{-41, 24}, {41, -24}}), Line(origin = {-51.625, 73.2812}, points = {{-43, -18}, {-33, -18}, {19, 18}, {39, 18}}, thickness = 0.5), Line(origin = {-51.625, 73.2812}, points = {{-43, -18}, {-33, -18}, {-8, 18}, {39, 18}}, color = {255, 0, 0}, thickness = 0.5), Line(origin = {-34.625, 78.5975}, points = {{-60, -14.6562}, {-26, -14.6562}, {2, 13.3438}, {22, 13.3438}}, color = {0, 170, 0}, thickness = 0.5), Text(origin = {8, 71}, extent = {{-14, 13}, {-4, -1}}, textString = "%"), Text(origin = {-40, 37}, extent = {{-14, 13}, {-4, -1}}, textString = "min"), Text(origin = {-17, -72}, extent = {{-27, 12}, {115, -26}}, textString = "%name")}, coordinateSystem(initialScale = 0.1)));
        end IconGTstartUp;
      end Icons;
    end BaseClases;
  end Gas_turbine;
