...
block pressure_control_2
  ...
  Modelica.Blocks.Continuous.PI PI(T = 10, initType = Modelica.Blocks.Types.Init.InitialOutput, k = 0.001, y_start = pos_start)  annotation(
...
equation
  connect(const_1.y, greater1.u2) annotation(
    Line(points = {{-81, -90}, {-72, -90}, {-72, -68}, {-60, -68}}, color = {0, 0, 127}));
