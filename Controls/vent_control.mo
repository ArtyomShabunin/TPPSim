...
block vent_control "Регулятор уроня в барабане КУ"
  ...
  Modelica.Blocks.Sources.Constant min_flow(k = 0.1) annotation(
  ...
  Modelica.Blocks.Sources.Constant open(k = 1) annotation(
    Placement(visible = true, transformation(origin = {10, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant close(k = 0) annotation(
    Placement(visible = true, transformation(origin = {10, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  connect(switch1.y, y) annotation(
    Line(points = {{62, 0}, {104, 0}, {104, 0}, {110, 0}}, color = {0, 0, 127}));
  connect(close.y, switch1.u1) annotation(
    Line(points = {{22, 30}, {26, 30}, {26, 8}, {38, 8}, {38, 8}}, color = {0, 0, 127}));
  connect(open.y, switch1.u3) annotation(
    Line(points = {{22, -30}, {26, -30}, {26, -8}, {38, -8}, {38, -8}}, color = {0, 0, 127}));
  ...
  connect(min_flow.y, gr.u2) annotation(
