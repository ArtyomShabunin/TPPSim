...
block control_EMA_028
  ...
  TPPSim.Controls.pressure_control_3 IP_pressure_control(P_activation = IP_P_activation, T = 35, k = 0.000005, pos_start = IP_pos_start, set_p = IP_set_p, speed_p = IP_speed_p) annotation(
    Placement(visible = true, transformation(origin = {30, 50}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
