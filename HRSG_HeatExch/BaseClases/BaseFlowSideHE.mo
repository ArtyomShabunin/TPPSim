...
partial model BaseFlowSideHE
  ...
  //Начальные значения
  outer parameter Modelica.SIunits.SpecificEnthalpy h_flow_start = Modelica.Media.Water.IF97_Utilities.BaseIF97.Regions.hv_p(p_flow_start) "Начальная энтальпия вода/пар" annotation(Dialog(tab = "Initialization"));    
