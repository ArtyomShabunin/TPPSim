...
//    Placement(visible = true, transformation(origin = {-29, 51}, extent = {{5, -5}, {-5, 5}}, rotation = 0)));
...
//    Placement(visible = true, transformation(origin = {-42, 30}, extent = {{4, -4}, {-4, 4}}, rotation = 0)));
  ...
  TPPSim.Valves.simpleValve HP_FWCV(redeclare package Medium = Medium_F, dp = 100000, m_flow_small = 0.0001, setD_flow = 30, use_D_flow_in = false) annotation(
    Placement(visible = true, transformation(origin = {37, 11}, extent = {{5, -5}, {-5, 5}}, rotation = 0)));
...
equation
  connect(HP_pipe.waterOut, flowSink.ports[1]) annotation(
    Line(points = {{-28, 30}, {-60, 30}, {-60, 30}, {-60, 30}}, color = {0, 127, 255}));
  ...
  connect(HP_FWCV.flowOut, EVO_1.flowIn) annotation(
    Line(points = {{32, 11}, {24, 11}, {24, -30}, {8, -30}, {8, -22}}, color = {0, 127, 255}));
  connect(FW_Pump.port_b, HP_FWCV.flowIn) annotation(
    Line(points = {{54, 32}, {50, 32}, {50, 11}, {42, 11}}, color = {0, 127, 255}));
