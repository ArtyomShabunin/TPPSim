...
model Heating
  ...
  inner Modelica.Fluid.System system(T_start = 373.15) annotation(
    Placement(visible = true, transformation(origin = {90, 90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  TPPSim.Pipes.ComplexPipe HP_pipe_1(redeclare TPPSim.Pipes.ElementarySteamPipe Pipe(redeclare TPPSim.thermal.alfaForSHandECO alpha), Din = 0.1645, Lpipe = 15.916, delta = 0.040, massDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, momentumDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, n_parallel = 2, numberOfVolumes = 3, p_flow_start = 101300) annotation(
    Placement(visible = true, transformation(origin = {-24, -26}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  TPPSim.Pipes.ComplexPipe HP_pipe_2(redeclare TPPSim.Pipes.ElementarySteamPipe Pipe(redeclare TPPSim.thermal.alfaForSHandECO alpha), Din = 0.2139, Lpipe = 38.317, delta = 0.055, massDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, momentumDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, numberOfVolumes = 5, p_flow_start = 101300) annotation(
  ...
  TPPSim.Pipes.ComplexPipe HRH_pipe_1(redeclare TPPSim.Pipes.ElementarySteamPipe Pipe(redeclare TPPSim.thermal.alfaForSHandECO alpha), Din = 0.417, Lpipe = 61.1347, delta = 0.020, massDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, momentumDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, n_parallel = 4, numberOfVolumes = 6, p_flow_start = 101300) annotation(
    Placement(visible = true, transformation(origin = {-76, -104}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  TPPSim.Pipes.ComplexPipe HRH_pipe_3(redeclare TPPSim.Pipes.ElementarySteamPipe Pipe(redeclare TPPSim.thermal.alfaForSHandECO alpha), Din = 0.560, Lpipe = 13.897, delta = 0.025, massDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, momentumDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, n_parallel = 2, numberOfVolumes = 3, p_flow_start = 101300) annotation(
    Placement(visible = true, transformation(origin = {16, -104}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  TPPSim.Pipes.ComplexPipe HRH_pipe_2(redeclare TPPSim.Pipes.ElementarySteamPipe Pipe(redeclare TPPSim.thermal.alfaForSHandECO alpha), Din = 0.417, Lpipe = 57.617, delta = 0.020, massDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, momentumDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, n_parallel = 4, numberOfVolumes = 3, p_flow_start = 101300) annotation(
