...
model Heating
  ...
  TPPSim.Controls.pressure_control_2 pressure_control_21(P_activation = 120000, T = 1, k = 0.0000001, pos_start = 1, set_p = 800000, speed_p = 500) annotation(
...
equation
  ...
  connect(Pipe10.waterOut, drain4.flowIn) annotation(
    Line(points = {{-64, -104}, {-48, -104}, {-48, -104}, {-48, -104}}, color = {0, 127, 255}));
  connect(drain4.flowOut, Pipe15.waterIn) annotation(
    Line(points = {{-40, -104}, {-26, -104}, {-26, -104}, {-26, -104}}, color = {0, 127, 255}));
  connect(drain4.flowOut, valveCompressible2.port_a) annotation(
  ...
  connect(const2.y, valve.opening) annotation(
  ...
  connect(RH11.flowOut, Pipe10.waterIn) annotation(
    Line(points = {{-82, -66}, {-94, -66}, {-94, -104}, {-88, -104}}, color = {0, 127, 255}));
