...
model Heating
  ...
  TPPSim.Pipes.ComplexPipe Pipe(redeclare TPPSim.Pipes.ElementaryPipe Pipe, Lpiezo = -10, energyDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial, massDynamics = Modelica.Fluid.Types.Dynamics.SteadyStateInitial,momentumDynamics = Modelica.Fluid.Types.Dynamics.SteadyState, numberOfVolumes = 1)  annotation(
