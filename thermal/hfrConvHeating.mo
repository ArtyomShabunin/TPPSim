...
model hfrConvHeating "Тепловой поток (HeatFlowRate) к внутренней стенке паропровода при прогреве без конденсации пара."
...
equation
  alpha_conv = TPPSim.thermal.falfaForSHandECO(stateFlow, D_flow_v, f_flow, Din); 
